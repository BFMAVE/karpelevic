...
export const topicVIIIResults: readonly ProofResultData[] = [
  ...
  },
  {
    ...
    takeaway: <>For N≥4, every non-inherited radial maximum satisfies the full hypothesis of <a href={sitePath("/proof/topic-vii/#part-i-item-4")}>Topic VII&apos;s closed-return product theorem</a>. The lower orders are handled directly in Topic XIII.</>,

...
export const topicVIIIResults: readonly ProofResultData[] = [
  ...
  },
  {
    ...
    takeaway: <>Every genuinely new stochastic radial extremum satisfies the full intrinsic hypothesis needed by Part I monodromy.</>,
...
export const topicXResults: readonly ProofResultData[] = [
  {
    ...
    purpose: "States the complete data packet imported from the geometric engine and verifies that a new-shell extremum satisfies its hypotheses.",
    ...
    intuition: <>All of Topics I-VII are compressed into a product identity, a lifted phase identity, and a common argument interval. No uniqueness of the polygon, contacts, or realizer is required.</>,
    proofSteps: [
      ...
      { title: "Invoke the completed geometric engine", explanation: <>Part I Theorem 1.4, proved in Topic VII, selects one adapted orientation and returns the Farey and monodromy data.</> },
...
export const topicXIResults: readonly ProofResultData[] = [
  ...
  },
  {
    ...
    takeaway: <>Every new-shell radial extremum is exactly the scalar Farey-Ito candidate and has a constant monodromy profile.</>,
    provenance: "New result",
    sourceIds: ["karpelevic-1951", "ito-1997"],

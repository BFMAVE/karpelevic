...
export const topicXIResults: readonly ProofResultData[] = [
  ...
  },
  {
    ...
    intuition: <>At every block terminal a simple cycle must commit: take the within-block return edge and close inside that block, or take inter-block edges all the way around every block.</>,
    proofSteps: [
      ...
      { title: "An inter-block edge fixes the suffix", explanation: <>After entering a block, the directed path forces the cycle to that block’s terminal.</> },
  ...
  },
  {
    ...
    intuition: <>Design the graph so within-block cycles reproduce the binomial (tᑫ−β)ᵈ and the cycle through all blocks supplies the remaining αᵈ monomial. The two signs of s−dq correspond to shortening the route inside blocks or subdividing one inter-block edge.</>,
    proofSteps: [
      ...
      { title: "Case s&gt;dq: subdivide one inter-block edge", explanation: <>Insert K=s−dq subdivision vertices. Collections of within-block cycles leave them unused and gain tᴷ; the cycle through all blocks uses them and has length s.</> },
  ...
  },
  {
    ...
    kind: "Corollary",
    title: "Stochastic realization of the candidate point",
    ...
    provenance: "Previously known",
    sourceIds: ["ito-1997", "johnson-paparella-2017", "kirkland-smigoc-2022"],
    sourceRelation: <>Classical realization results go back to Karpelevič and Ito, with explicit matrix treatments by Johnson–Paparella and Kirkland–Šmigoc. This corollary follows from the construction just proved.</>,
  },
  {
    ...
    vocabulary: [
      { term: "Equality in the radial bound", definition: <>The upper comparison gives ρ≤ρ*, while realization and radial maximality give ρ*≤ρ. Hence ρ=ρ*, activating the strict equality condition in Jensen’s inequality.</> },
    ...
    proofSteps: [
      ...
      { title: "Independent reverse inequality", explanation: <>Corollary II.7.4 puts ρ*e<sup>iθ</sup> in Θ<sub>N</sub>. Since ρ=R<sub>N</sub>(θ) is the maximal attainable radius, <span className="math-inline">ρ*≤ρ</span>.</> },

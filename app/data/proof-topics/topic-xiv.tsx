  ...
  return (
    <>
        ...
        background={[
          {
            label: "Bisection",
            explanation:
              "the elementary root-finding method that repeatedly halves an interval on which a continuous function changes sign. In binary64 arithmetic the implementation stops when the midpoint can no longer refine its bracket.",
          },
          {
        ...
        <header>
          ...
          <div>
            ...
            <p>
              ...
              and Θ<sub>2</sub>=[−1,1]. For the Farey–Ito construction below,
              assume <i>n</i>≥3. Let <i>F</i><sub>n</sub> be the increasing
            ...
            <p>
              ...
              0&lt;α&lt;1, 0&lt;β&lt;1, and α+β=1. The value
              λ=ρe<sup>2πix</sup> is the corresponding boundary point.
            </p>
            <p>
      ...
      <section className="topic-i-textbook proof-chapter-group topic-xiv-ray">
        <header>
          <div>
            <p className="section-label">2 · One value from beginning to end</p>
        ...
        <ol className="topic-xiv-worked-steps">
          <li>
            ...
            <div>
              ...
              <p>
                ...
                3·2−1·5=1 and 3+5=8&gt;7. The complete Farey criterion therefore
                proves that 1/3 and 2/5 are consecutive in <i>F</i><sub>7</sub>.
          ...
          <li>
            <span>2</span>
            <div>
              <h4>Compute d and e, then clear the negative exponent</h4>
              <p>
      ...
      <section className="topic-i-textbook proof-chapter-group topic-xiv-code">
        <header>
          ...
          <div>
            <p>
              ...
              binary64 bisection with at most ninety updates.
            </p>
          </div>
        </header>
        <div className="topic-xiv-code-ledger">
          <div>
            ...
            <p>Reduced fractions, Farey-neighbour tests, relabelling so q&lt;s, d, e, and rational endpoint parameters.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p>The published tests cover the complete order-seven table, x=3/8, exact orders one and two, the exceptional order-three endpoint contract and real segment, interval residuals, conjugation, and invalid inputs.</p>
          </div>
        </div>
        ...
        <p>
          ...
          orders from 1 through 40. The open-interval helper excludes Farey
          endpoints. A separate radial helper returns value 1 at every
          root-of-unity endpoint, including x=1/2 at order three; the nonreal
          order-three branch instead has one-sided limiting modulus 1/2 before
          the exact segment [−1,−1/2] is inserted.
        </p>
      </section>

...
const rawItems: readonly [
  ...
  [13, "Lemma", "Support-face test for strict polygons", "Identifies a side through equality with a supporting functional."],
  ...
  [16, "Theorem", "Hereditary saturation", "Strengthens side saturation from one critical polygon to every admissible subpolygon with the same vertex budget."],
  ...
  [19, "Definition", "Half-open ownership word", "Introduces a cyclic word that assigns a boundary contact to exactly one of its two possible incident sides."],
  [20, "Lemma", "Half-open side atlas", "Partitions the entire polygon boundary into consistently oriented half-open sides."],
  [21, "Lemma", "Boundary-face rigidity", "Forces every point in a convex combination onto the same exposed face when the combination reaches that face."],
  [22, "Lemma", "Boundary segment locator", "Locates a boundary point on the unique side or vertex dictated by cyclic order."],
  [23, "Proposition", "Labeled side-matrix certificate", "Encodes polygon invariance and side contacts by a nonnegative matrix that preserves the side labels."],
  [24, "Lemma", "Local ownership at unchanged vertices", "Shows that a local modification cannot silently change the ownership convention at untouched vertices."],
  [25, "Lemma", "Edge-cap clipping with exact vertex count", "Clips an inactive cap while controlling strictness and the number of remaining vertices exactly."],
  [26, "Lemma", "Area-minimal cap bound", "Uses an area-minimal polygon to rule out caps that would produce a smaller admissible competitor."],
  ...
  [29, "Proposition", "Collision-free global half-open ownership", "Chooses one global half-open convention that assigns every contact without collision."],
  [30, "Theorem", "One-sided contact representative", "Produces a representative in which all contacts follow the same cyclic direction."],
  ...
  [33, "Lemma", "Intrinsic exact mutation law", "Expresses contact surgery as a coordinate-free chip move on the cyclic ownership data."],
  [34, "Proposition", "Geometric realization of every legal chip sequence", "Shows that every legal combinatorial mutation sequence comes from actual invariant polygons."],
  ...
  [36, "Theorem", "Reduced strict block and first record", "Reduces an arbitrary contact configuration to one consecutive block and identifies its first return record."],
  ...
  [38, "Lemma", "Endpoint-padded upper-record sections", "Adds endpoint conventions that make the return sections work uniformly at the boundary cases."],
  ...
  [42, "Theorem", "Exact return-edge ledger", "Lists every edge, endpoint, and return time needed by the global deformation with no suppressed cases."],
  ...
  [44, "Lemma", "Admissible projective chart", "Chooses a coordinate on the initial side in which the corridor holonomy is fractional-linear and ordered."],
  ...
  [48, "Theorem", "Global deformation admissibility", "Checks simultaneously that the entire return-corridor deformation remains a strict invariant polygon."],
  [49, "Proposition", "Global return-corridor deformation", "Assembles the local projection moves into one admissible global deformation."],
  ...
  [56, "Proposition", "Identity-contact rotation closes after reflection", "Shows that unit projective return makes the reflected contact orbit close with the required arithmetic data."],
  [57, "Theorem", "Nontransversal case", "Derives the heterogeneous contact-product relation when the lifted return angle is strictly larger than the step."],
  [58, "Theorem", "Transversal case", "Derives the companion product relation when the lifted return angle equals the step."],
  [59, "Theorem", "Return factors lie on the Jensen sheet", "Places all heterogeneous contact factors on one controlled logarithmic sheet and extracts the scalar carrier equation."],
  ...
  [64, "Theorem", "Representative-selection Farey compression", "Applies the polygon theorem to recover the classical Farey-indexed boundary of the stochastic eigenvalue region."],
...
export const proofTopics: readonly ProofTopic[] = [
  ...
  },
  {
    ...
    overview: [
      ...
      "The central conclusion is hereditary saturation: not only the chosen critical polygon, but every admissible subpolygon with the same vertex budget has all of its sides active. This is a genuine strengthening of the earlier saturation theorem and is the safeguard needed for later surgery.",
    ],
  ...
  {
    slug: "ownership",
    eyebrow: "Topic III · 10 items",
    title: "Building one-sided ownership",
    question:
      "When a contact lands at a vertex, which of the two incident sides owns it?",
    overview: [
      "A boundary contact can be ambiguous exactly at a vertex. Half-open sides remove the ambiguity locally, but the proof needs one convention that works around the entire polygon without collisions.",
      "Clipping and area minimality rule out inactive caps; a finite endpoint ledger then promotes the local choice to a global one-sided contact representative. Dmitriev and Dynkin already contain the underlying contact theorem, while this manuscript makes the endpoint bookkeeping explicit.",
    ],

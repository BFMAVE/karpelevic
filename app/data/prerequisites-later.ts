...
export const prerequisiteChapters: readonly PrerequisiteChapter[] = [
  {
    ...
    facts: [
      ...
      },
      {
        ...
        explanation:
          "The two choices are conjugate and induce opposite orientations. The proof may use one orientation for contact bookkeeping and later select the other for the finite product equation.",
      },
      {
  ...
  },
  {
    ...
    partIUse: [
      ...
      },
      {
        label: "Topic VII",
        text:
          "For N≥4, unimodular return data determines consecutive Farey fractions, a finite product equation, and an equality for chosen real arguments; the smaller orders are treated directly.",
        href: "/proof/#topic-farey-return",
      },
      {
        label: "History",

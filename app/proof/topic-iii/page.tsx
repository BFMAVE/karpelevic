  ...
  return (
    <ProofChapterShell
      ...
      overview={[
        ...
        "Clipping along an edge of the image polygon preserves invariance and gives an explicit upper bound for the number of remaining vertices. Hausdorff compactness and strict area monotonicity then produce a least-area normalized polygon whose discarded boundary arcs satisfy the bound proved on this page.",
      ]}
      stats={[

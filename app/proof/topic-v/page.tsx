...
export const metadata: Metadata = {
  title: "Topic V — Rotation Arithmetic, First-Return Towers, and the Projective Boundary Argument",
  description:
    "A complete guided account of finite rotation records for N≥2 and the projective boundary construction used to prove unit return for N≥4.",
};
  ...
  return (
    <AdvancedProofChapter
      ...
      overview={[
        ...
        "The tower tops are then read as polygon contacts. For N≥4, consecutive boundary vertices omitting at least one side and an exhaustive four-set partition prepare the chain of perspectivities used in Topic VI.",
      ]}
      provedHere={
        <p>
          ...
          not yet prove Δ=1. For N≥4, Topic VI supplies the projective
          deformation and completes the contradiction under the temporary
